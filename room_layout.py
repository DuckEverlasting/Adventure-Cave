...
class Room:
    ...
    def __repr__(self):
        return f"Room{self.coord}"



def populate_level(rooms, connections, empty_pct, empty_var, spread):
    # Rooms are arranged around the root at (0, 0). A "ring"
...
printout(test_case, 17)
check_connections(test_case)