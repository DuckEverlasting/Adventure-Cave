...
mob = {
    "goblin": Mob(
        ...
        text = {
            ...
            "dead": (
                f"The {text_style['mob']('goblin')} cries out in shock as your attack connects. He gives you a baleful glare that fades into a look of weary resignation as he slumps to the ground, dead.",
            ),
            "attack_success": (
